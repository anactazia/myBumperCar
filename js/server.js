...
var WebSocketServer = require("c:/Program/nodejs/websocket").server;
var Game = require("c:/wamp/www/javascript/me/kmom07-10/myBumperCar/js/game");
...
// Starts the HTTP server on port 1337.
...
// pick out his car from the pack. Here we take note of the index that belongs to
// him.
Indices[ID] = CarData.length - 1;
}
// Go through all of the connections and send them personalized messages. Each user
// gets the list of all the cars, but also the index of his car in that list.
for (var ID in Connections)
